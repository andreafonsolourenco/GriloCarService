<%@ Page Language="C#" AutoEventWireup="true" CodeFile="config_ficha_fornecedor.aspx.cs" Inherits="config_ficha_fornecedor" %>
...
<head>
    ...
    <meta name="description" content="Grilo Car Service Software - Ficha de Fornecedor">
    <meta name="author" content="André Lourenço">
    <title>Grilo Car Service Software - Ficha de Fornecedor</title>
    <!-- Favicon -->
    ...
    <div class="main-content">
        ...
        <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
            <div class="container-fluid">
                <!-- Brand -->
                <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block">Fornecedores</a>
                <!-- User -->
            ...
            <div class="container-fluid d-flex align-items-center">
                <div class="row">
                    <div class="col-lg-12 col-md-10">
                        <h1 class="display-2 text-white" id="divInfoTitle">Fornecedores</h1>
                        <p class="text-white mt-0 mb-5" id="divInfoSubTitle">Crie/Edite os Fornecedores</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="card bg-secondary shadow">
                        <div class="card-header bg-white border-0">
                            <div class="row align-items-center">
                                <table style="width: 100%; margin-left: 15px">
                                    <tr>
                                        <td style="width: 90%">
                                            <h3 class="mb-0" id="sectionTitle">Fornecedores</h3>
                                        </td>
                        ...
                        <div class="card-body" id="divGrelha">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-control-label" for="txtIban">IBAN</label>
                                        <input type="text" id="txtIban" class="form-control form-control-alternative" placeholder="IBAN" onfocusout="validateIBAN(false);">
                                    </div>
                                </div>
                            </div>

                            <div class="row">
                                <div class="col-md-4" id="divNIF">
                                    <div class="form-group">
                                        <label class="form-control-label" for="txtNIF">NIF</label>
                                        <input type="text" id="txtNIF" class="form-control form-control-alternative" placeholder="NIF" onfocusout="checkProvider(false);">
                                    </div>
                                </div>
                                <div class="col-md-4" id="divNumDiasPagamento">
                                    <div class="form-group">
                                        <label class="form-control-label" for="txtNumDiasPagamento">Nº Dias Pagamento</label>
                                        <input type="number" id="txtNumDiasPagamento" class="form-control form-control-alternative" placeholder="Nº Dias Pagamento">
                                    </div>
                                </div>
    ...
    <script>
        ...
        function getData() {
            ...
            if (id != null && id != 'null' && id != '') {
                $.ajax({
                    type: "POST",
                    url: "config_ficha_fornecedor.aspx/getData",
                    data: '{"id":"' + id + '"}',
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (res) {
                        ...
                        $('#txtNIF').val(nif);
                        $('#txtNotes').val(notas);
                        $('#txtNumDiasPagamento').val(numDiasPagamento);
        ...
        function saveData() {
            ...
            var numDiasPagamento = $('#txtNumDiasPagamento').val();
            ...
            else if (iban == '' || iban == null || iban == undefined) {
                sweetAlertWarning('IBAN', 'Por favor indique o IBAN');
                return;
            }
            ...
            $.ajax({
                type: "POST",
                url: "config_ficha_fornecedor.aspx/saveData",
                data: '{"idUser":"' + localStorage.loga + '","id":"' + id + '","name":"' + name + '","address":"' + address + '","zipCode":"' + zipCode + '","city":"' + city + '","nif":"' + nif +
                    '","email":"' + email + '","notes":"' + notes + '","iban":"' + iban + '","active":"' + active + '","numdiaspagamento":"' + numDiasPagamento + '"}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (res) {
                    var dados = res.d.split('<#SEP#>');
                    ...
                    if (parseInt(dados[0]) < 0) {
                        ...
                        loadUrl("lista_fornecedores.aspx");
                    }
                }
            });
        }
