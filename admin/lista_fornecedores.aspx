<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lista_fornecedores.aspx.cs" Inherits="lista_fornecedores" %>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="description" content="Grilo Car Service Software - Fornecedores">
    <meta name="author" content="André Lourenço">
    <title>Grilo Car Service Software - Fornecedores</title>
    <!-- Favicon -->
...
<body>
                            ...
                            <table style="width: 100%">
                                <tr>
                                    ...
                                    <td style="width: 15%; max-width: 15% !important; text-align: right;">
                                        <div id="divCriaNovoFornecedor">
                                            <a class="btn btn-sm btn-primary" onclick="novo();" style="color: #FFFFFF;">
                                                <span id="spanBtnAlteraStatus"><i class="fa fa-store" aria-hidden="true"></i>  Criar novo fornecedor</span>
                                            </a>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <table style="width:100%; height: auto;">
                                    <tr>
                                        <td style="width: 25%; max-width: 25% !important; text-align: left;">
                                            <div>
                                                <button type='button' style="width:100%; height: 100%;" class='btn btn-sm btn-primary' id='buttonFileUpload' onclick='simulateClickOnFileUploadButton();' runat='server'>Carregar Ficheiro Fornecedores</button>
                                            </div>                                        
                                        </td>
    ...
    <script>
        ...
        function loga() {
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    if (administrador == 0) {
                        $('#formUploadProviders').fadeOut();
                        $('#divCriaNovoFornecedor').fadeOut();
                    }
                    else {
                        $('#formUploadProviders').fadeIn();
                        $('#divCriaNovoFornecedor').fadeIn();
                    }
                }
            });
        }
        ...
        function getData() {
            loadingOn('A carregar os fornecedores. Por favor aguarde...');
            var pesquisa = $('#txtPesquisa').val();
            var order = "";

            if (ordNome == 0 && ordNif == 0) {
                ...
                if (ordNome != 0) {
                    ...
                    order += ordNif == -1 ? ' nif desc ' : ' nif asc ';
                }
            }

            $.ajax({
                type: "POST",
                url: "lista_fornecedores.aspx/getGrelha",
        ...
        function editar(id) {
            loadUrl('config_ficha_fornecedor.aspx?id=' + id);
        }

        function eliminar(id) {
            swal({
                title: 'Eliminar fornecedor',
                text: "O fornecedor será eliminado. Confirma?",
                type: 'question',
        ...
        function delRow(id) {
            $.ajax({
                type: "POST",
                url: "lista_fornecedores.aspx/delRow",
                ...
                success: function (res) {
                    ...
                    if (parseInt(res) <= 0) {
                        sweetAlertWarning("Eliminar fornecedores", resMsg);
                    }
                    else {
                        $('#txtPesquisa').val('');
                        ordNome = 0;
        ...
        function novo() {
            loadUrl('config_ficha_fornecedor.aspx');
        }
        ...
        function visualizar(id) {
            $.ajax({
                ...
                data: '{"idUser":"' + localStorage.loga + '","id":"' + id + '","tipo":"' + 'FORNECEDORES' + '"}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (res) {
                    var dados = res.d;
                    ...
                    swal({
                        title: "<strong>DADOS DO FORNECEDOR</strong>",
                        html: dados,
                        showCancelButton: false,
